...
x = symbols('x')
f = (x*math.e**(-x) + sp.ln(x**2)) * (2*x**3 + 2*x**2 - 3*x - 5)
f_prime = f.diff(x)
f = lambdify(x,f)
f_prime = lambdify(x,f_prime)
# PART A
print("drill for part a\n my id 208376095\n 3+7 = 10\n question 10")
print("newton:")
newton_for_roots(f,-1, 1.5)
print("secant:")
secantMethod(f,-1,1.5)
print("simpsone:")
simpson_method(f, 4)
